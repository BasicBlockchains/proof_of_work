...
class Formatter():
    ...
    # MINE AMOUNT/REWARD
    STARTING_REWARD_EXPONENT = 2
    STARTING_REWARD = pow(2, STARTING_REWARD_EXPONENT)
    HALVING_NUMBER = 15  # TESTING #0x80520  # 525,600
    TOTAL_MINING_AMOUNT = 2 * HALVING_NUMBER * (pow(2, STARTING_REWARD_EXPONENT + 1) - 1)
